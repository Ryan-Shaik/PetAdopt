                    ...
                    <div className="flex items-center space-x-4">
                        {user ? (
                            ...
                            <div className="flex items-center space-x-2">
                                <Link to="/login" className="bg-teal-600 hover:bg-teal-700 text-white font-medium py-2 px-3 rounded-md transition-colors duration-200 flex items-center gap-1"> {/* Use gray-700 and hover:teal-600 */}
                                    <LogIn className="h-5 w-5" /> Login
                                </Link>
                                <Link to="/signup" className="bg-teal-600 hover:bg-teal-700 text-white py-2 px-4 rounded-md transition duration-300 font-medium flex items-center gap-1 shadow-sm"> {/* Use amber-500 and hover:amber-600 */}
